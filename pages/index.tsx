  ...
  return (
    <>
      ...
      <main className={styles.home}>
        ...
        <p>* Due to mudslides on I-70 in the Glenwood Canyon the highway has been closed. The only alternative route is through Independence Pass.</p>
        <p><a href="https://goo.gl/maps/e8yqojpYES4srM2DA" rel="noreferrer" target="_blank">Click here</a> to view route.</p>
      </main>
    </>
  );
};
